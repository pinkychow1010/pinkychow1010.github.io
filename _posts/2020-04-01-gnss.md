...
<figure>
  <img src={{ 'assets/images/glacier.png' | relative_url }} alt="Priestley Glacier" style="width:100%">
...
<figure>
  <img {{ 'assets/images/glacier2.png' | relative_url }} alt="Priestley Glacier" style="width:100%">
  <figcaption>The performance of different GNSS processing tools</figcaption>
</figure>

<figure>
  <img {{ 'assets/images/glacier3.png' | relative_url }} alt="Priestley Glacier" style="width:100%">
