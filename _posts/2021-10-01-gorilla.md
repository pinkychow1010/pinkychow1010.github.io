...
<img src="{{ 'assets/images/water-resources.jpg' | relative_url }}" alt="climate-change" />

<figure>
  <img src={{ 'assets/images/gorilla.jpg' | relative_url }} alt="Mountain Gorilla" style="width:100%">
  <figcaption>Gorillas of Volcanoes National Park</figcaption>
</figure>

<figure>
  <img src={{ 'assets/images/data-viz.png' | relative_url }} alt="Dashboard" style="width:100%">
